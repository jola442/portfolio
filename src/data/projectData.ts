...
export const projects: ProjectItem[] = [
    {
        id: uuidv4(),
        title: "Chessmask - Blindfold Chess Training Platform",
        imgLink: "/Chessmask.png", // Replace with a screenshot from your site
        description: "A web application designed to help chess players develop blindfold chess and board visualization skills through interactive training exercises. Built with Next.js, the platform provides drills focused on board awareness, square recognition, coordinates, and mental visualization. The application emphasizes progressive skill development through immediate feedback, responsive design, and an intuitive user experience.",
        summary: "A Next.js web application that helps players improve blindfold chess and board visualization skills through interactive training drills.",
        gitHubLink: "",
        demoLink: "https://chessmask.com",
        videoLink: "",
        date: "2026",
        tools: [
